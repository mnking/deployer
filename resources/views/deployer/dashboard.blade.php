...
@section('content')
    ...
    @component('deployer.component.page-title')
                ...
                <div class="grid-body no-border">
                    <div class="row-fluid">
                        <div class="span8">
                            ...
                            <p>Basic buttons are traditional buttons with borders and background. Use any of the
                                available button classes to quickly create a styled button. Compatible for bootstrap
                                version 2 and 3.</p>
                            <br>
            ...
            <div class="grid simple">
                ...
                <div class="grid-body no-border">
                    <div class="row-fluid">
                        ...
                        <p>Adding on top of existing browser controls, Bootstrap includes other useful form components.
                            Add text or buttons before or after any text-based input. Do note that select elements are
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="radio radio-primary">
                                        ...
                                        <input id="ADisabled" type="radio" name="ADisabled" value="ADisabled"
                ...
                <div class="grid-body no-border">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br>
                            <input type="hidden" value="" style="width:300px" id="e12" tabindex="-1"
                ...
                <div class="grid-body no-border">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p>Here is an attached calender in case you want to see how it looks like, this is only used
                                for a demo purpose</p>
                            <br>
        ...
        <div class="col-md-6">
            <div class="grid simple">
                ...
                <div class="grid-body no-border">
                    ...
                    <p>Hardly used but we included it too, You can pick a color and return it to any element you
                        want</p>
                    <br>
                    <a data-color="rgb(255, 255, 255)" data-color-format="hex" id="cp4"
                       class="btn btn-primary my-colorpicker-control" href="#" data-colorpicker-guid="8">Change
                        background color</a>
                    <br>
                    <br>
                    <div class="clearfix"></div>
        ...
        <div class="col-md-12">
            <div class="grid simple">
                ...
                <div class="grid-body no-border">
                    ...
                    <p>Simple, elegant WYSIYG editor that acts as a word editor all necessary actions that is required
                        to type simple content with style is available in this editor. Its powererd by HTML5 WYSIYG
                        editor which will work even on any mobile device. Simply place it any <code>textarea</code></p>
                    <br>
                    ...
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <div class="row-fluid">
                                ...
                                <p>Do you use tags to organize content on your site? This plugin will turn your boring
                                    tag list into a magical input that turns each tag into a style-able object with its
                                    own delete link. </p>
                                <br>
                                <input class="span12 tagsinput" type="text" value="Amsterdam,Washington"
                                       data-role="tagsinput"/>
                                <input class="span12 tagsinput" type="text"
                                       value="johnsmith@webarc.com,janesmith@webarc.com" data-role="tagsinput"/>
